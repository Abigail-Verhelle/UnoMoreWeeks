...
const numRooms = 1;
const maxPeople = 2; //two to ten players 
...
function startGame(name) {
  ...
  if (people == 2) {
    ...
    let sockets_ids = Object.keys(io.sockets.adapter.Players.get(name).length);
...
/*
  ...
  //   room = Object.keys(io.sockets.adapter.sids[socket.id])[1]; /// broken here
  //     if (room !== undefined) {
